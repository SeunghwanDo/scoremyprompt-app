...
const PRICING_PLANS = {
  free: {
    ...
    features: [
      { text: '10 analyses/day', included: true },
      { text: 'All 6 dimensions', included: true },
      { text: 'Weekly leaderboard', included: true },
      { text: 'Share your score', included: true },
      { text: 'Ads shown', included: false },
      { text: 'No history', included: false },
      { text: 'No rewrite', included: false },
    ],
  },
  pro: {
    name: 'Pro',
    ...
    features: [
      ...
      { text: 'Bulk analysis (5 at once)', included: true },
