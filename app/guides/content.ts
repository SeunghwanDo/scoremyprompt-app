    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          '✓ Use ScoreMyPrompt: Before sending your prompt to the AI, check your PROMPT Score at scoremyprompt.app to identify gaps.',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          'Tip 15 - Score Your Prompts with PROMPT Framework: After crafting a prompt, evaluate it against six dimensions: Precision, Role, Output Format, Mission Context, Structure, and Tailoring. Use scoremyprompt.app to identify which dimensions need strengthening, then refine.',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          'Exercise 5 - Score Your Prompts: Go to scoremyprompt.app and analyze 3-5 of your actual prompts. Identify which dimensions (Precision, Role, Output Format, Mission Context, Structure, Tailoring) are weak. Rewrite to improve your score.',
        ],
      },
      {
        ...
        content: [
          ...
          'Step 5 - Score Regularly: Every few days, paste a prompt into scoremyprompt.app and see your PROMPT Score. Track how it improves as you learn.',
