...
const MOCK_STATS: DashboardStats = {
  totalAnalyses: 47,
  bestScore: { value: 92, grade: 'S' },
  averageScore: 78,
  mostUsedRole: 'Marketing',
};

const MOCK_TREND_DATA: TrendDataPoint[] = Array.from({ length: 14 }, (_, i) => ({
...
const MOCK_RECENT_ANALYSES: RecentAnalysis[] = [
  {
    id: 1,
    date: '2025-02-20',
    prompt: 'Create a comprehensive go-to-market strategy...',
    score: 92,
    grade: 'S',
  },
  {
    id: 2,
    date: '2025-02-19',
    prompt: 'Design a mobile app interface for meditation...',
    score: 78,
    grade: 'A',
  },
  {
...
export default function DashboardPage() {
  ...
  const { user, tier, loading, setShowAuth, setAuthMessage } = useAuth();
